...
const _functions         = _argv._.length > 0 ? _argv._ : ['json => json']
...
const _fs                = _functions.map(f => eval(f))
...
let _apply               = _selectPlugin('applicator', _applicator, _applicators)(_verbose, _failEarly, _fs, _argv)
